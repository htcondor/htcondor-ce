...
The [JobRouter](https://htcondor.readthedocs.io/en/v9_0/grid-computing/job-router.html) is at the heart of HTCondor-CE
...
| >= 8.9.5                          | **First matching route** where routes are considered in the order specified by [JOB_ROUTER_ROUTE_NAMES](https://htcondor.readthedocs.io/en/v9_0/admin-manual/configuration-macros.html#JOB_ROUTER_ROUTE_NAMES) |
...
[HTCondor manual](https://htcondor.readthedocs.io/en/v9_0/misc-concepts/classad-mechanism.html#classad-operators).
...
-   Setting various HTCondor-specific attributes like `JobLeaseDuration`, `Requirements` and `Periodic_Hold` (see the
    [HTCondor manual](https://htcondor.readthedocs.io/en/v9_0/classad-attributes/job-classad-attributes.html)).
