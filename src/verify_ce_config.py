...
def main():
    ...
    for attr in ['JOB_ROUTER_DEFAULTS', 'JOB_ROUTER_ENTRIES']:
        try:
            ...
            # Only raise an error if neither JOB_ROUTER_ENTRIES nor any JOB_ROUTER_ROUTE_<name> configuration knobs are set
            if attr == "JOB_ROUTER_ENTRIES" and not jr_transforms:
