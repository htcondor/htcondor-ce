...
if [[ $BUILD_ENV == osg* ]]; then
    ...
    # This is currently tracking the 25.x feature release.
    ...
    yum install -y https://research.cs.wisc.edu/htcondor/repo/25.x/htcondor-release-current.el${OS_VERSION}.noarch.rpm
fi
